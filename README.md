...
**一站式配置 Claude Code、Codex、CodeBuddy 和 WorkBuddy 使用七牛 AI API 端点的 CLI 工具**
...
- **Claude Code CLI** ([安装地址](https://claude.ai/download))、**Codex CLI** (`npm install -g @openai/codex`)、**CodeBuddy CLI** (`npm install -g @tencent-ai/codebuddy-code`) 和/或 **WorkBuddy**
...
如果 Claude Code、Codex、CodeBuddy 或 WorkBuddy 正在运行，请重启以应用配置。
